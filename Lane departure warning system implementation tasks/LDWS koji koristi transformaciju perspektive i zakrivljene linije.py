...
def slidingWindow(binary_img, color_img, x_left, x_right):
    ...
    for i in range(0, noWindows):
        ...
        cv2.rectangle(color_img, (x_pos - windowSize_X_2, y_pos - windowSize_Y_2),
                      (x_pos + windowSize_X_2, y_pos + windowSize_Y_2), (0, 255, 0), 3)

        y, x = np.where(binary_img[y_pos - windowSize_Y_2: y_pos + windowSize_Y_2,
                        x_pos - windowSize_X_2: x_pos + windowSize_X_2] == 255)
